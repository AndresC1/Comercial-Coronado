...
from Buscar_producto import buscar
...
def productos():
    class Inventario:
        ...
        def __init__(self, ventana):
            ...
            self.encabezado = Button(self.titulo, text="INVENTARIO", font=("Arial",20,"bold"), bg="DodgerBlue4", fg="snow").place(x=450, y=50)
            self.opciones = Frame(self.ventana, height="98")
            self.opciones.config(bg="AntiqueWhite1")
            self.opciones.pack(fill = X)
            self.boton_01 = Button(self.opciones, text="Agregar",height="2", width="38", bg="CadetBlue3",command=agregar_producto).place(x=0,y=0)
            self.boton_02 = Button(self.opciones, text="Editar",height="2", width="38", bg="CadetBlue3", command=self.edit_product).place(x=275,y=0)
            self.boton_03 = Button(self.opciones, text="Buscar",height="2", width="38", bg="CadetBlue3",command=buscar).place(x=550,y=0)
            self.boton_04 = Button(self.opciones, text="Eliminar",height="2", width="38", bg="CadetBlue3", command=self.delete_product).place(x=825,y=0)
            ...
            self.tabla.column("#1", width=490)
            self.tabla.column("#2", width=20)
            self.tabla.column("#4", width=25)
            self.tabla.column("#3", width=90)
