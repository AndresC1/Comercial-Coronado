...
def fact():
    class Buscar_fact:
        ...
        def __init__(self, ventana):
            ...
            self.encabezado = Label(self.titulo, text="Buscar Factura", font=("Arial",15,"bold"), bg="DodgerBlue4", fg="snow").place(x=300, y=20)
            #Frame de Entry
            ...
            #Mes
            Label(self.panel, text="Mes",bg="AntiqueWhite1").place(x=190,y=50)
